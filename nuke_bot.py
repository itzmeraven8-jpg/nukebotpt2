...
async def nuke_help(ctx):
    ...
    embed1.add_field(name="— MASS MEMBER ACTIONS —", value="\u200b",                                        inline=False)
    ...
    embed2.add_field(name="— CHANNEL CONTROL —",     value="\u200b",                                        inline=False)
    ...
    embed2.add_field(name="— ROLE CONTROL —",        value="\u200b",                                        inline=False)
    ...
    embed2.add_field(name="— SERVER CONTROL —",      value="\u200b",                                        inline=False)
